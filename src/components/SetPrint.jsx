...
useEffect(() => {
  ...
  fetchStudents(search, strand, section);
    ...
    console.log("Selected IDs:", selectedIds);
        ...
        .then(res => {
        // ✅ Option A: pass the selected IDs & fetched data as route state
            navigate("/setprint/printid", {
                state: {
                ids: selectedIds,
          ...
          <div className="sticky top-12 z-10 w-full mx-auto bg-white flex flex-col lg:flex-row items-center gap-4 max-w-6xl pt-8 pb-4">
            ...
            <button
              ...
              onClick={() => {
                ...
                navigate('/setprint', { replace: true });
                fetchStudents();
              }}
            >
              Clear Filter
            ...
            <button
                className="w-full lg:w-48 bg-sky-900 text-white p-3 rounded hover:bg-sky-700"
                    ...
                    <tr key={index} className="hover:bg-gray-300 text-sm bg-gray-200">
                        <td className="border border-gray-400 p-2 text-center">
                            ...
                            <div className="flex items-center justify-center">
                              <UserCircleIcon className="border border-gray-100 rounded-full h-16 w-16 text-gray-400"/>
                            </div>
                          )}
                        </td>
                        ...
                        <td className="border border-gray-400 p-2">
                            <div className="text-center">
                                <input className="w-6 h-6" type="checkbox" checked={selectedIds.includes(s.id)} onChange={() => handleCheckboxChange(s.id)}/>
                            </div>
                        </td>
                    </tr>
                  ))
